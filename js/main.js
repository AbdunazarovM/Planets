Vue.component("planets", {
        ...
        <div class="site-header__container container">
          ...
          <nav class="navbar">
            ...
            <ul class="navbar-list">
              ...
              v-for="planetsMenus in planetsMenu">
                <span class="navbar-tab"
                @click="selectedPlanet = planetsMenus">{{ planetsMenus }}</span>
              </li>
            </ul>
          </nav>
        </div>
  ...
  data() {
    return  {
      planetsMenu: ["Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune"],
      planetStructure: ["overview", "internal structure", "surface geology"],
      infoPlanet: ["rotation time", "revolution time", "radius", "average temp"],
